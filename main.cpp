...
string passGen(int num_words) {
    ...
    for(int i=0; i<num_words; i++) {
        int rand_index = rand() % wordslen;
        password += words[rand_index];
    }
...
string swap_letters(string password) {
    ...
    string swapped = password.substr(len-2) + password.substr(2, len-4) + password.substr(0, 2);
    return swapped;
}
